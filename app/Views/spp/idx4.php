                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="btn-group float-right">
                                ...
                                <a href="spp/excel4" type="button" class="btn btn-success" name="excel4">
                                    <b>
                                        <i class="fas fa-file-csv"></i>&nbsp;&nbsp;Excel
                                    </b>
                                </a>
                                <a href="spp/print4" type="button" class="btn btn-light" name="print4">
                                    <b>
                                        ...
                                        foreach ($dosen0072 as $key => $row) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        <a href="<?php echo base_url('spp/show4/' . $row['id']); ?>" class="btn btn-sm btn-primary">
