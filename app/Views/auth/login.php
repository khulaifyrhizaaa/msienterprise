...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url('auth/login'); ?>"><b>MSI</b>3 Sugihwaras</a>
    </div>
    <div class="card">
      <diva class="card-body login-card-body">
        ...
        <div class="row">
          <div class="col-8">
            <p class="mb-0">
              ...
              <a href="<?php echo base_url('auth_siswa/login_siswa'); ?>" class="btn btn-warning">Login as Siswa</a>
            </p>
          </div>
          <div class="col-4">
