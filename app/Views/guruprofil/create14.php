...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url('guruprofil/store14'); ?>" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-body">
                                <?php
                                // if (!empty($inputs)){
                            ...
                            <div class="card-footer">
                                <a href="<?php echo base_url('guruprofil'); ?>" class="btn btn-outline-info">Back</a>
