...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit Data Anda</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url('guruprofil/update14'); ?>" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-body">
                                <?php
                                ...
                                <div class="form-group">
                                    <label for="">NIP</label>
                                    <input type="text" value="<?php echo $dataguru['nip']; ?>" class="form-control" name="nip" placeholder="Masukkan NIP ">
                                </div>
                                <div class="form-group">
                                    <label for="">NIK</label>
                                    <input type="text" value="<?php echo $dataguru['nik']; ?>" class="form-control" name="nik" placeholder="Masukkan NIK ">
                                </div>
                                <div class="form-group">
                                    <label for="">ID PEGAWAI</label>
                                    <input type="text" value="<?php echo $dataguru['id_pegawai']; ?>" class="form-control" name="id_pegawai" placeholder="Masukkan ID Pegawai ">
                                </div>
                                <div class="form-group">
