...
<head>
  ...
  <title>Log in SISWA- MSI 3</title>
...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url('auth_siswa/login_siswa'); ?>"><b>Login Siswa MSI</b> 3 Sugihwaras</a>
    </div>
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <div class="row">
          <div class="col-8">
            <p class="mb-0">
              <a href="<?php echo base_url('auth_siswa/register_siswa'); ?>" class="text-center">Register</a>
            </p>
            <p class="mb-0">
