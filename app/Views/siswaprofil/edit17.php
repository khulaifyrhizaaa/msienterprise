...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Profil Siswa</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url('siswaprofil/update17'); ?>" method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-body">
                                <?php
                                ...
                                <input type="hidden" name="nis" value="<?php echo $emis['nis']; ?>">
                                <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $emis['nisn']; ?>" class="form-control" name="nisn" placeholder="Masukkan NISN">
                                </div>
                                <div class="form-group">
                                    <label for="">NIK</label>
                                    <input type="text" value="<?php echo $emis['nik']; ?>" class="form-control" name="nik" placeholder="Masukkan NIK">
                                </div>
                                <div class="form-group">
